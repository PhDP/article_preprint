...
publishers and discuss the preprint policies of major publishers in biology.
...
\begin{table}[!ht]
    ...
    \hline
    Website               & Free & Comments & Private preprints & Peer-reviewed & DOI & Version-Control & Other Content\\
    \hline
    ...
    \end{tabular}
    \begin{flushleft}
    \textbf{Free:} Whether preprints can be submitted for free.
    \textbf{Comments:} Support for online comments on the item.
    ...
    \texbbf{Version-Control:} Is the preprint stored with a version-control system with the complete history of modifications?
