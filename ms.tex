...
Preprint servers such as arXiv are common in mathematics and physics,
but still a minority of papers in ecology and evolution use
them. Preprint servers allow authors to make their manuscripts
publicly available before, or at the same time as, submitting them to
journals for traditional peer-review. ...  The idea became popular
with arXiv, and many physicists start their day with a look at the new
papers in ArXiv \cite{gin11}
