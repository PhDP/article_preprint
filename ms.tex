...
The ongoing discussions on the scientific publication process, peer-review and
alternative publication models are all symptoms of the current uneasiness with
the ever growing obsession with bibliographic metrics such as the impact factor
\cite{Fisher2012}. Researchers are pressured to orient their publication
strategy to maximize their number of publications in top journals and total
citations. A well-known consequence is the initial submission of manuscripts to
the most prestigious journals, followed by resubmission to progressively ``lower
level'' journals as they are rejected. The numerous negative impacts of such
behavior have been discussed in depth \cite{hoc09} and include a long delay
between the time a manuscript is finished and its publication. Research
activities and the publication process are drifting away from their fundamental
objective, namely the distribution of novel scientific discoveries.

Developing a preprint culture in biology will not solve all of the problems with
the current publication process. However, it might significantly reduce the
negative consequences. The role of peer-review is to judge the scientific
quality of a study. It is the first barrier against fraudulent and poor quality
science that could impede scientific progress. In practice, the peer-review
system is not only used to evaluate scientific quality but also to judge
pertinence. In contrast, preprints are not filtered based on either quality or
pertinence. Widespread adoption of preprint servers has the potential to shift
the distribution strategy making scientific results immediately available to the
community, while allowing traditional journals to validate the results and
showcase scientific discoveries for their readership.
...
stringent peer review, the quality and perceived importance of published papers
may be improved, but at the cost of an increased load on authors and reviewers,
and greater delays for publication.  By developing a preprint culture in biology
we can speed up the dissemination of scientific discoveries and potentially
improve the quality of initial submissions to journals through pre-publication
peer-review.
