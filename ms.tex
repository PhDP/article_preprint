...
strategy to maximize their number of publications and total citations. A
...
quality science that could impede scientific progress. In practice, the
peer-review system is not only used to evaluate scientific quality but also to
judge pertinence. On the other hand, preprints are not filtered on either
quality or pertinence. Widespread adoption of preprint servers has the potential
to shift the distribution strategy: journals would remain important to validate
