...
% To expand:
Part of the hostility to preprint servers come from a the Ingelginfer rule:
scientists should not publish the same manuscript twice \cite{alt96}. 
A second potential problem is embargoes. Many publishers ... \cite{rea12}
