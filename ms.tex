...
describe the main options to publish preprints (Box 1, Table 2).
...
\subsection{Figure 1 (map.tiff)}

It can take several months before a submitted paper is
...
\subsection{Figure 2 (arxiv.tiff)}
