...
access publisher that combines both a preprint server and a peer reviewed
journal. Preprints can be made private and shared only with selected colleagues.
Only one preprint per year can be posted for free, with a onetime (\emph{i.e.}
lifetime) fee required to allow an author to post unlimited public preprints.
Preprints can be posted to PeerJ regardless of where they will eventually be
