...
In contrast, there is a surprising perception in biology that public preprints
make it easier to steal ideas. Since there is no evidence that this has happened
in the numerous other fields that have adopted preprint servers, and since preprint
servers create a clear record of who had the idea first, and when, this would
appear to be a largely unfounded concern.
%I'm torn over whether to keep the biology part in this paragraph where it is 
%topically related, or to move it down into the biological sciences part of the ms
